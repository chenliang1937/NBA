 ...
 */
public class BlogFragment extends SwipeRefreshBaseFragment implements RecyclerViewLoadMoreListener.OnLoadMoreListener {
    ...
    public void onLoadMore() {
        if (newsAdapter.canLoadMore()){
            ...
            newsAdapter.notifyItemChanged(newsAdapter.getItemCount() - 1);
            AppService.getInstance().loadMoreNews(getTaskId(), Constant.NEWSTYPE.BLOG.getNewsType(), newsId);
        }
    }
